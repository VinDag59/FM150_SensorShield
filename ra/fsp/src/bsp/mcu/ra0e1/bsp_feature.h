...
#define BSP_FEATURE_ADC_D_CHANNELS                                (0x006000FFUL)    // Mask of available channels.
#define BSP_FEATURE_ADC_D_SCAN_MODE_CHANNELS                      (0x1FUL)          // Mask of channels available in scan mode.
...
#define BSP_FEATURE_SCI_ADDRESS_MATCH_CHANNELS                    (0x00UL)          // Feature not available on this device.
#define BSP_FEATURE_SCI_CHANNELS                                  (0x00UL)          // Feature not available on this device.
...
#define BSP_FEATURE_SCI_LIN_CHANNELS                              (0x00UL)          // Feature not available on this device.
#define BSP_FEATURE_SCI_SPI_SCKSEL_VALUE                          (0UL)             // Feature not available on this device.
#define BSP_FEATURE_SCI_UART_ABCSE_RESTRICTED_CHANNELS            (0x00UL)          // Feature not available on this device.
#define BSP_FEATURE_SCI_UART_CSTPEN_CHANNELS                      (0x00UL)          // Feature not available on this device.
#define BSP_FEATURE_SCI_UART_DE_IS_INVERTED                       (0UL)             // Feature not available on this device.
#define BSP_FEATURE_SCI_UART_FIFO_CHANNELS                        (0x00UL)          // Feature not available on this device.
...
#define BSP_FEATURE_SPI_CLK                                       (FSP_PRIV_CLOCK_UNUSED)   // Feature not available on this device.
...
#define BSP_FEATURE_SPI_MAX_CHANNEL                               (0UL)             // Feature not available on this device.
