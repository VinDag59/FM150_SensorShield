...
#define PIN_SO11 (BSP_IO_PORT_02_PIN_13)
#define CFG_SO11 ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN | (uint32_t) IOPORT_PERIPHERAL_SAU4_OUT)
#define PIN_SCK11 (BSP_IO_PORT_04_PIN_07)
#define CFG_SCK11 ((uint32_t) IOPORT_CFG_PERIPHERAL_PIN | (uint32_t) IOPORT_PERIPHERAL_SAU1_OUT)
